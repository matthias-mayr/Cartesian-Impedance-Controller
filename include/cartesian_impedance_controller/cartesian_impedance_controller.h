...
public:
  ...
  Eigen::VectorXd get_commanded_torques(const Eigen::Matrix<double, 7, 1> &q, const Eigen::Matrix<double, 7, 1> &dq,
  ...
  void get_robot_state(Eigen::Matrix<double, 7, 1> &q, Eigen::Matrix<double, 7, 1> &dq, Eigen::Vector3d &position,
                       Eigen::Quaterniond &orientation, Eigen::Vector3d &position_d, Eigen::Quaterniond &orientation_d,
  ...
  Eigen::Matrix<double, 7, 1> saturate_torque_rate(const Eigen::Matrix<double, 7, 1> &tau_d_calculated,
                                                   Eigen::Matrix<double, 7, 1> &tau_J_d, double delta_tau_max_) const;
...
private:
  ...
  void update_states(const Eigen::Matrix<double, 7, 1> &q, const Eigen::Matrix<double, 7, 1> &dq,
                     const Eigen::Matrix<double, 6, 7> &jacobian, const Eigen::Vector3d &position,
                     const Eigen::Quaterniond &orientation, const Eigen::Vector3d &position_d_target,
