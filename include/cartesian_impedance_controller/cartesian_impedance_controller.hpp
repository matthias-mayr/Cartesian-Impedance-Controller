...
public:
   ...
   *
   * This function assumes that the internal states have already been updates. The it utilizes the control rules to
   * calculate commands. \return Eigen Vector of the commanded torques
   */
...
protected:
  ...
  Eigen::Matrix<double, 6, 6> cartesian_stiffness_{ Eigen::Matrix<double, 6, 6>::Identity() };  //!< Cartesian stiffness
                                                                                                //!< matrix
  Eigen::Matrix<double, 6, 6> cartesian_damping_{ Eigen::Matrix<double, 6, 6>::Identity() };    //!< Cartesian damping
                                                                                                //!< matrix
  ...
  };  //!< Cartesian stiffness target
  Eigen::Matrix<double, 6, 6> cartesian_damping_target_{ Eigen::Matrix<double, 6, 6>::Identity() };  //!< Cartesian
                                                                                                     //!< damping target
  ...
  Eigen::Matrix<double, 6, 1> cartesian_wrench_target_{ Eigen::Matrix<double, 6, 1>::Zero() };  //!< Cartesian wrench
                                                                                                //!< target
