...
public:
    ...
    void initialize_parameters(double &filter_params_,double &nullspace_stiffness_, double &nullspace_stiffness_target_);
    ...
    */
    ...
    bool updateControl(Eigen::Matrix<double, 7, 1> &q, Eigen::Matrix<double, 7, 1> &dq,
                       ...
                       Eigen::VectorXd &tau_d, Eigen::Matrix<double, 6, 1> &error, const double delta_tau_max_);
...
private:
    ...
    Eigen::Matrix<double, 7, 1> saturateTorqueRate(
        ...
        const Eigen::Matrix<double, 7, 1> &tau_J_d,const double delta_tau_max_); // NOLINT (readability-identifier-naming)
